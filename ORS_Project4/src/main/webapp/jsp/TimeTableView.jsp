			...
			<tr>
				 ...
				 <td>
						<%
							...
							map1.put("1", "1st Semester");
							map1.put("2", "2nd Semester");
							map1.put("3", "3rd Semester");
							map1.put("4", "4th Semester");
							map1.put("5", "5th Semester");
							map1.put("6", "6th Semester");
							map1.put("7", "7th Semester");
							map1.put("8", "8th Semester");

							String htmlList1 = HTMLUtility.getList("semester", bean.getSemester(), map1);
						%> <%=htmlList1%></td>
				</tr> 
